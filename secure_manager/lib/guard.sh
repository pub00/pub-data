#!/bin/bash
# ==============================================================================
# lib/guard.sh — Auto-Lock Background Service (systemd)
# ==============================================================================
#
...
#   Unlike system services (sudo), user services run as YOUR user.
#   They live in ~/.config/systemd/user/ and are managed with
#   'systemctl --user' instead of 'systemctl'.
#
...
EOF
    ...
    ui_info "Security Guard: Started and enabled."
}
